...
class ManageWarehouses extends SettingsPage
{
    ...
    public function form(Form $form): Form
    {
        return $form
            ->components([
                Toggle::make('enable_locations')->label(__('inventories::filament/clusters/settings/pages/manage-warehouses.form.enable-locations'))
