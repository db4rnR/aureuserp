...
class CreateWarehouse extends CreateRecord
{
    ...
    private function createLocations(array $data): array
    {
        ...
        $data['input_stock_location_id'] = Location::create([
            ...
            'creator_id' => $data['creator_id'],
            'company_id' => $data['company_id'],
            'deleted_at' => in_array($data['reception_steps'], [ReceptionStep::TWO_STEPS, ReceptionStep::THREE_STEPS], true) ? null : now(),
        ])->id;
        ...
        $data['output_stock_location_id'] = Location::create([
            ...
            'creator_id' => $data['creator_id'],
            'company_id' => $data['company_id'],
            'deleted_at' => in_array($data['delivery_steps'], [DeliveryStep::TWO_STEPS, DeliveryStep::THREE_STEPS], true) ? null : now(),
        ])->id;
    ...
    private function createOperationTypes(array $data): array
    {
        ...
        $data['xdock_type_id'] = OperationType::create([
            ...
            'company_id' => $data['company_id'],
            'creator_id' => $data['creator_id'],
            'deleted_at' => in_array($data['reception_steps'], [ReceptionStep::TWO_STEPS, ReceptionStep::THREE_STEPS], true) &&
                in_array($data['delivery_steps'], [DeliveryStep::TWO_STEPS, DeliveryStep::THREE_STEPS], true) ? null : now(),
        ])->id;

        return $data;
    }

    private function createRoutes(array $data): array
    {
    ...
    private function createRules(array $data): array
    {
        $supplierLocation = Location::where('type', LocationType::SUPPLIER)->first();
