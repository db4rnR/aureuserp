...
class PayAction extends Action
{
    protected function setUp(): void
    {
        ...
        $this
            ...
            || ! in_array($record->payment_state, [PaymentState::NOT_PAID, PaymentState::PARTIAL, PaymentState::IN_PAYMENT], true));
    }
    ...
    private function createMoveLine(Move $record, Move $newMove, Payment $payment, array $data): void
    {
        MoveLine::create([
            'move_id' => $newMove->id,
