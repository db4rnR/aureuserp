...
class BankResource extends Resource
{
                ...
                Section::make(__('partners::filament/resources/bank.form.sections.general.title'))
                    ->schema([
                        TextInput::make('name')->label(__('partners::filament/resources/bank.form.sections.general.fields.name'))
                            ->maxLength(255)
                            ->required(),
                        TextInput::make('code')->label(__('partners::filament/resources/bank.form.sections.general.fields.code'))
                            ->maxLength(255),
                        TextInput::make('email')->label(__('partners::filament/resources/bank.form.sections.general.fields.email'))
                            ->email()
                            ->maxLength(255),
                        TextInput::make('phone')->label(__('partners::filament/resources/bank.form.sections.general.fields.phone'))
                            ->tel()
                            ->maxLength(255),
                    ])
                    ->columns(2),
                Section::make(__('partners::filament/resources/bank.form.sections.address.title'))
                    ->schema([
                        Select::make('country_id')->label(__('partners::filament/resources/bank.form.sections.address.fields.country'))
                            ...
                            ->preload()
                            ->live(),
                        Select::make('state_id')->label(__('partners::filament/resources/bank.form.sections.address.fields.state'))
                            ->relationship(
                                name: 'state',
                                titleAttribute: 'name',
                            ...
                            ->searchable()
                            ->preload(),
                        TextInput::make('street1')->label(__('partners::filament/resources/bank.form.sections.address.fields.street1'))
                            ->maxLength(255),
                        TextInput::make('street2')->label(__('partners::filament/resources/bank.form.sections.address.fields.street2'))
                            ->maxLength(255),
                        TextInput::make('city')->label(__('partners::filament/resources/bank.form.sections.address.fields.city'))
                            ->maxLength(255),
                        TextInput::make('zip')->label(__('partners::filament/resources/bank.form.sections.address.fields.zip'))
                            ->maxLength(255),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                TextColumn::make('name')->label(__('partners::filament/resources/bank.table.columns.name'))
                    ->searchable()
                    ->sortable(),
                TextColumn::make('code')->label(__('partners::filament/resources/bank.table.columns.code'))
                    ->searchable()
                    ->sortable(),
                TextColumn::make('country.name')->label(__('partners::filament/resources/bank.table.columns.country'))
                    ->numeric()
                    ->sortable()
                    ->sortable(),
            ...
            ->groups([
                Group::make('country.name')->label(__('partners::filament/resources/bank.table.groups.country')),
                Group::make('created_at')->label(__('partners::filament/resources/bank.table.groups.created-at'))
                    ->date(),
            ])
            ->recordActions([
