...
class WebsitePlugin implements Plugin
{
    ...
    private function getTopNavigationItems(): Collection
    {
        return new Collection([
            NavigationItem::make('Login')->url(filament()->getLoginUrl())
                ->visible(! filament()->auth()->check()),
            NavigationItem::make('Register')->url(filament()->getRegistrationUrl())
                ->visible(! filament()->auth()->check()),
        ]);
    }
    ...
    private function getNavigationItems(): Collection
    {
        ...
        $pages->each(function ($page) use ($navigationItems): void {
            $navigationItems->push(
                NavigationItem::make($page->slug)->label($page->title)
    ...
    private function getSocialLinks(): Collection
    {
        ...
        if ($contactSettings->facebook) {
            $socialLinks->push(
                NavigationItem::make('Facebook')->url('https://faceboox.com/'.$contactSettings->facebook)
        ...
        if ($contactSettings->twitter) {
            $socialLinks->push(
                NavigationItem::make('Twitter')->url('https://twitter.com/'.$contactSettings->twitter)
        ...
        if ($contactSettings->instagram) {
            $socialLinks->push(
                NavigationItem::make('Instagram')->url('https://instagram.com/'.$contactSettings->instagram)
        ...
        if ($contactSettings->youtube) {
            $socialLinks->push(
                NavigationItem::make('YouTube')->url('https://youtube.com/'.$contactSettings->youtube)
        ...
        if ($contactSettings->linkedin) {
            $socialLinks->push(
                NavigationItem::make('LinkedIn')->url('https://linkedin.com/in/'.$contactSettings->linkedin)
        ...
        if ($contactSettings->pinterest) {
            $socialLinks->push(
                NavigationItem::make('Pinterest')->url('https://pinterest.com/'.$contactSettings->pinterest)
        ...
        if ($contactSettings->tiktok) {
            $socialLinks->push(
                NavigationItem::make('TikTok')->url('https://tiktok.com/@'.$contactSettings->tiktok)
        ...
        if ($contactSettings->github) {
            $socialLinks->push(
                NavigationItem::make('GitHub')->url('https://github.com/'.$contactSettings->github)
        ...
        if ($contactSettings->whatsapp) {
            $socialLinks->push(
                NavigationItem::make('WhatsApp')->url('https://wa.me/'.$contactSettings->whatsapp)
        ...
        if ($contactSettings->slack) {
            $socialLinks->push(
                NavigationItem::make('Slack')->url('https://slack.com/'.$contactSettings->slack)
