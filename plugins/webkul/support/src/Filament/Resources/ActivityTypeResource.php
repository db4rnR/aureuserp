                ...
                Group::make()->schema([
                        Group::make()->schema([
                                Section::make(__('support::filament/resources/activity-type.form.sections.activity-type-details.title'))
                                    ->schema([
                                        TextInput::make('name')->label(__('support::filament/resources/activity-type.form.sections.activity-type-details.fields.name'))
                                            ->required()
                                            ->maxLength(255)
                                            ->live(onBlur: true)
                                        ...
                                        Select::make('category')->label(__('support::filament/resources/activity-type.form.sections.activity-type-details.fields.action'))
                                            ->options(ActivityTypeAction::options())
                                            ->live()
                                            ->searchable()
                                            ->preload(),
                                        Select::make('default_user_id')->label(__('support::filament/resources/activity-type.form.sections.activity-type-details.fields.default-user'))
                                            ->options(fn () => User::query()->pluck('name', 'id'))
                                            ->searchable()
                                            ->preload(),
                                        Textarea::make('summary')->label(__('support::filament/resources/activity-type.form.sections.activity-type-details.fields.summary'))
                                            ->columnSpanFull(),
                                        RichEditor::make('default_note')->label(__('support::filament/resources/activity-type.form.sections.activity-type-details.fields.note'))
                                            ->columnSpanFull(),
                                    ])
                                    ->columns(2),
                                Section::make(__('support::filament/resources/activity-type.form.sections.delay-information.title'))
                                    ->schema([
                                        TextInput::make('delay_count')->label(__('support::filament/resources/activity-type.form.sections.delay-information.fields.delay-count'))
                                            ->numeric()
                                            ->required()
                                            ->default(0)
                                            ->minValue(0)
                                            ->maxValue(999999999),
                                        Select::make('delay_unit')->label(__('support::filament/resources/activity-type.form.sections.delay-information.fields.delay-unit'))
                                            ->required()
                                            ->default(ActivityDelayUnit::MINUTES->value)
                                            ->options(ActivityDelayUnit::options()),
                                        Select::make('delay_from')->label(__('support::filament/resources/activity-type.form.sections.delay-information.fields.delay-form'))
                                            ->required()
                        ...
                        Group::make()->schema([
                                Section::make(__('support::filament/resources/activity-type.form.sections.advanced-information.title'))
                                    ->schema([
                                        IconPicker::make('icon')->label(__('support::filament/resources/activity-type.form.sections.advanced-information.fields.icon'))
                                            ->sets(['heroicons', 'fontawesome-solid'])
                                            ->columns(4)
                                            ->preload()
                                            ->optionsLimit(50),
                                        Select::make('decoration_type')->label(__('support::filament/resources/activity-type.form.sections.advanced-information.fields.decoration-type'))
                                            ->options(ActivityDecorationType::options())
                                            ->native(false),
                                        Select::make('chaining_type')->label(__('support::filament/resources/activity-type.form.sections.advanced-information.fields.chaining-type'))
                                        ...
                                        Select::make('activity_type_suggestions')->multiple()
                                        ...
                                        Select::make('triggered_next_type_id')->relationship('triggeredNextType', 'name')
                                ...
                                Section::make(__('support::filament/resources/activity-type.form.sections.status-and-configuration-information.title'))
                                    ->schema([
                                        Toggle::make('is_active')->label(__('support::filament/resources/activity-type.form.sections.status-and-configuration-information.fields.status'))
                                            ->default(false),
                                        Toggle::make('keep_done')->label(__('support::filament/resources/activity-type.form.sections.status-and-configuration-information.fields.keep-done-activities'))
                                            ->default(false),
                                    ]),
                            ])
                            ->columnSpan(['lg' => 1]),
        ...
        return $table
            ->columns([
                TextColumn::make('name')->searchable()
                    ...
                    ->sortable(),
                TextColumn::make('summary')->label(__('support::filament/resources/activity-type.table.columns.summary'))
                    ->searchable()
                    ->sortable(),
                TextColumn::make('delay_count')->label(__('support::filament/resources/activity-type.table.columns.planned-in'))
                    ->formatStateUsing(fn ($record): string => $record->delay_count ? "{$record->delay_count} {$record->delay_unit}" : 'No Delay'),
                TextColumn::make('delay_from')->label(__('support::filament/resources/activity-type.table.columns.type'))
                ...
                TextColumn::make('category')->badge()
                    ...
                    ->sortable(),
                IconColumn::make('is_active')->label(__('support::filament/resources/activity-type.table.columns.status'))
                    ->boolean()
                    ->sortable(),
                TextColumn::make('created_at')->label(__('support::filament/resources/activity-type.table.columns.created-at'))
                    ->date()
                    ->sortable()
                    ->toggleable(isToggledHiddenByDefault: true),
                TextColumn::make('updated_at')->label(__('support::filament/resources/activity-type.table.columns.updated-at'))
                    ->date()
                    ->sortable()
                    ->toggleable(isToggledHiddenByDefault: true),
            ])
            ->groups([
                Tables\Grouping\Group::make('name')->label(__('support::filament/resources/activity-type.table.groups.name'))
                    ->collapsible(),
                Tables\Grouping\Group::make('category')->label(__('support::filament/resources/activity-type.table.groups.action-category'))
                    ->collapsible(),
                Tables\Grouping\Group::make('is_active')->label(__('support::filament/resources/activity-type.table.groups.status'))
                    ->collapsible(),
                Tables\Grouping\Group::make('delay_count')->label(__('support::filament/resources/activity-type.table.groups.delay-count'))
                    ->collapsible(),
                Tables\Grouping\Group::make('delay_unit')->label(__('support::filament/resources/activity-type.table.groups.delay-unit'))
                    ->collapsible(),
                Tables\Grouping\Group::make('delay_from')->label(__('support::filament/resources/activity-type.table.groups.delay-source'))
                    ->collapsible(),
                Tables\Grouping\Group::make('chaining_type')->label(__('support::filament/resources/activity-type.table.groups.chaining-type'))
                    ->collapsible(),
                Tables\Grouping\Group::make('decoration_type')->label(__('support::filament/resources/activity-type.table.groups.decoration-type'))
                    ->collapsible(),
                Tables\Grouping\Group::make('defaultUser.name')->label(__('support::filament/resources/activity-type.table.groups.default-user'))
                    ->collapsible(),
                Tables\Grouping\Group::make('created_at')->label(__('support::filament/resources/activity-type.table.groups.creation-date'))
                    ->date()
                    ->collapsible(),
                Tables\Grouping\Group::make('updated_at')->label(__('support::filament/resources/activity-type.table.groups.last-update'))
                    ->date()
                    ->collapsible(),
            ])
            ->filters([
                SelectFilter::make('category')->multiple()
                    ...
                    ->options(ActivityTypeAction::options()),
                TernaryFilter::make('is_active')->label(__('support::filament/resources/activity-type.table.filters.status')),
                Filter::make('has_delay')->label(__('support::filament/resources/activity-type.table.filters.has-delay'))
                ...
                Grid::make(['default' => 3])->schema([
                        Group::make()->schema([
                                ...
                                Section::make(__('support::filament/resources/activity-type.infolist.sections.delay-information.title'))
                                    ->schema([
                                        TextEntry::make('summary')->label(__('support::filament/resources/activity-type.infolist.sections.activity-type-details.entries.summary'))
                                            ->placeholder('—')
                                            ->columnSpanFull(),
                                        TextEntry::make('default_note')->label(__('support::filament/resources/activity-type.infolist.sections.activity-type-details.entries.note'))
                                            ->html()
                                            ->placeholder('—')
                                            ->columnSpanFull(),
                                    ]),
                                Section::make(__('support::filament/resources/activity-type.infolist.sections.delay-information.title'))
                                    ->schema([
                                        ...
                                        TextEntry::make('delay_from')->icon('heroicon-o-arrow-right')
                                            ->placeholder('—')
                                            ->formatStateUsing(fn ($state) => ActivityDelayFrom::options()[$state])
                        ...
                        Group::make()->schema([
                                Section::make(__('support::filament/resources/activity-type.infolist.sections.advanced-information.title'))
                                    ->schema([
                                        TextEntry::make('icon')->icon(fn ($record) => $record->icon)
                                            ->placeholder('—')
                                            ->label(__('support::filament/resources/activity-type.infolist.sections.advanced-information.entries.icon')),
                                        TextEntry::make('decoration_type')->icon('heroicon-o-paint-brush')
                                        ...
                                        TextEntry::make('chaining_type')->icon('heroicon-o-link')
                                        ...
                                        TextEntry::make('suggestedActivityTypes.name')->icon('heroicon-o-list-bullet')
                                            ->placeholder('—')
                                            ->label(__('support::filament/resources/activity-type.infolist.sections.advanced-information.entries.suggest'))
                                            ->listWithLineBreaks(),
                                        TextEntry::make('triggeredNextType.name')->icon('heroicon-o-forward')
                                            ->placeholder('—')
                                ...
                                Section::make(__('support::filament/resources/activity-type.infolist.sections.status-and-configuration-information.title'))
                                    ->schema([
                                        IconEntry::make('is_active')->label(__('support::filament/resources/activity-type.infolist.sections.status-and-configuration-information.entries.status')),
                                        IconEntry::make('keep_done')->label(__('support::filament/resources/activity-type.infolist.sections.status-and-configuration-information.entries.keep-done-activities')),
                                    ]),
                            ])->columnSpan(1),
                    ]),
            ]);
