...
class CalendarAttendance extends RelationManager
{
        ...
        return $form
            ->components([
                Section::make(__('employees::filament/clusters/configurations/resources/calendar/relation-managers/working-hours.form.sections.general.title'))
                    ...
                    ->schema([
                        TextInput::make('name')->label('')
                            ...
                            ->required()
                            ->maxLength(255),
                        Select::make('day_of_week')->label(__('employees::filament/clusters/configurations/resources/calendar/relation-managers/working-hours.form.sections.general.fields.day-of-week'))
                            ->searchable()
                            ->preload()
                ...
                Section::make(__('employees::filament/clusters/configurations/resources/calendar/relation-managers/working-hours.form.sections.timing-information.title'))
                    ->columns(2)
                    ->schema([
                        Select::make('day_period')->label(__('employees::filament/clusters/configurations/resources/calendar/relation-managers/working-hours.form.sections.timing-information.fields.day-period'))
                            ->searchable()
                            ->preload()
                            ->options(DayPeriod::options())
                            ->required(),
                        Select::make('week_type')->label(__('employees::filament/clusters/configurations/resources/calendar/relation-managers/working-hours.form.sections.timing-information.fields.week-type'))
                            ->searchable()
                            ->preload()
                            ->options(WeekType::options()),
                        TimePicker::make('hour_from')->label(__('employees::filament/clusters/configurations/resources/calendar/relation-managers/working-hours.form.sections.timing-information.fields.work-from'))
                            ->native(false)
                            ->required(),
                        TimePicker::make('hour_to')->label(__('employees::filament/clusters/configurations/resources/calendar/relation-managers/working-hours.form.sections.timing-information.fields.work-to'))
                            ->native(false)
                            ->required(),
                    ]),
                ...
                Section::make(__('employees::filament/clusters/configurations/resources/calendar/relation-managers/working-hours.form.sections.additional-information.title'))
                    ->columns(1)
                    ->schema([
                        Select::make('display_type')->label(__('employees::filament/clusters/configurations/resources/calendar/relation-managers/working-hours.form.sections.additional-information.fields.display-type'))
                            ->options(CalendarDisplayType::options()),
                        TextInput::make('duration_days')->label(__('employees::filament/clusters/configurations/resources/calendar/relation-managers/working-hours.form.sections.additional-information.fields.durations-days'))
                            ->numeric()
                            ->default(1)
                            ->minValue(0)
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->columns([
                TextColumn::make('name')->label(__('employees::filament/clusters/configurations/resources/calendar/relation-managers/working-hours.table.columns.name'))
                    ->searchable()
                    ->sortable(),
                TextColumn::make('day_of_week')->label(__('employees::filament/clusters/configurations/resources/calendar/relation-managers/working-hours.table.columns.day-of-week'))
                    ->formatStateUsing(fn ($state) => DayOfWeek::options()[$state]),
                TextColumn::make('day_period')->label(__('employees::filament/clusters/configurations/resources/calendar/relation-managers/working-hours.table.columns.day-period'))
                    ->formatStateUsing(fn ($state): string => ucfirst((string) $state))
                    ->badge()
                    ->color('secondary'),
                TextColumn::make('hour_from')->label(__('employees::filament/clusters/configurations/resources/calendar/relation-managers/working-hours.table.columns.work-from')),
                TextColumn::make('hour_to')->label(__('employees::filament/clusters/configurations/resources/calendar/relation-managers/working-hours.table.columns.work-to')),
                TextColumn::make('date_from')->label(__('employees::filament/clusters/configurations/resources/calendar/relation-managers/working-hours.table.columns.starting-date'))
                    ->date(),
                TextColumn::make('date_to')->label(__('employees::filament/clusters/configurations/resources/calendar/relation-managers/working-hours.table.columns.ending-date'))
                    ->date(),
                TextColumn::make('display_type')->label(__('employees::filament/clusters/configurations/resources/calendar/relation-managers/working-hours.table.columns.display-type'))
                    ->badge(),
                TextColumn::make('created_at')->label(__('employees::filament/clusters/configurations/resources/calendar/relation-managers/working-hours.table.columns.created-at'))
                    ->toggleable(isToggledHiddenByDefault: true),
                TextColumn::make('updated_at')->label(__('employees::filament/clusters/configurations/resources/calendar/relation-managers/working-hours.table.columns.updated-at'))
                    ->toggleable(isToggledHiddenByDefault: true),
            ])
            ->filters([
                SelectFilter::make('day_of_week')->label(__('employees::filament/clusters/configurations/resources/calendar/relation-managers/working-hours.table.filters.day-of-week'))
                    ->options(DayOfWeek::options()),
                SelectFilter::make('display_type')->label(__('employees::filament/clusters/configurations/resources/calendar/relation-managers/working-hours.table.filters.display-type'))
                    ->searchable()
                    ->preload()
                    ->options(CalendarDisplayType::options()),
            ])
                ...
                Grid::make(['default' => 3])->schema([
                        Group::make()->schema([
                                Section::make(__('employees::filament/clusters/configurations/resources/calendar/relation-managers/working-hours.infolist.sections.general.title'))
                                    ->schema([
                                        ...
                                        TextEntry::make('day_of_week')->formatStateUsing(fn ($state) => DayOfWeek::options()[$state])
                                            ->placeholder('—')
                                            ->icon('heroicon-o-clock')
                                ...
                                Section::make((__('employees::filament/clusters/configurations/resources/calendar/relation-managers/working-hours.infolist.sections.timing-information.title')))
                                    ->schema([
                                        TextEntry::make('day_period')->label(__('employees::filament/clusters/configurations/resources/calendar/relation-managers/working-hours.infolist.sections.timing-information.entries.day-period'))
                                            ->placeholder('—')
                                            ->formatStateUsing(fn ($state) => DayPeriod::options()[$state])
                                            ->icon('heroicon-o-clock'),
                                        TextEntry::make('week_type')->formatStateUsing(fn ($state) => WeekType::options()[$state])
                                            ...
                                            ->placeholder('—')
                                            ->icon('heroicon-o-clock'),
                                        TextEntry::make('hour_from')->label(__('employees::filament/clusters/configurations/resources/calendar/relation-managers/working-hours.infolist.sections.timing-information.entries.work-from'))
                                            ->placeholder('—')
                                            ->icon('heroicon-o-clock'),
                                        TextEntry::make('hour_to')->label(__('employees::filament/clusters/configurations/resources/calendar/relation-managers/working-hours.infolist.sections.timing-information.entries.work-to'))
                                            ->placeholder('—')
                                            ->icon('heroicon-o-clock'),
                                    ])->columns(2),
                        ...
                        Group::make([
                            Section::make((__('employees::filament/clusters/configurations/resources/calendar/relation-managers/working-hours.infolist.sections.date-information.title')))
                                ->schema([
                                    TextEntry::make('date_from')->icon('heroicon-o-calendar')
                                        ->placeholder('—')
                                        ->date()
                            ...
                            Section::make((__('employees::filament/clusters/configurations/resources/calendar/relation-managers/working-hours.infolist.sections.additional-information.title')))
                                ->schema([
                                    TextEntry::make('display_type')->formatStateUsing(fn ($state) => CalendarDisplayType::options()[$state])
                                        ->placeholder('—')
                                        ...
                                        ->icon('heroicon-o-clock'),
                                    TextEntry::make('duration_days')->placeholder('—')
