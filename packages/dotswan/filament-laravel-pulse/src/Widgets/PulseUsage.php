...
final class PulseUsage extends Widget
{
    protected string $view = 'filament-laravel-pulse::widgets.pulse-usage';
    ...
    {
        $config = config('filament-laravel-pulse.components.usage');
