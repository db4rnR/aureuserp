...
final class PulseSlowQueries extends Widget
{
    protected string $view = 'filament-laravel-pulse::widgets.pulse-slow-queries';
    ...
    {
        $config = config('filament-laravel-pulse.components.slow-queries');
